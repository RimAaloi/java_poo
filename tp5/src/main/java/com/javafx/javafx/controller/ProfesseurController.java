...
public class ProfesseurController implements Initializable {
    ...
    private void setupActionsColumn() {
        actionsColumn.setCellFactory(param -> new TableCell<>() {
            ...
            {
                // Style des boutons
                editBtn.setStyle("-fx-background-color: #ffb74d; -fx-text-fill: white; -fx-border-radius: 3;");
                deleteBtn.setStyle("-fx-background-color: #f44336; -fx-text-fill: white; -fx-border-radius: 3;");
                assignBtn.setStyle("-fx-background-color: #64b5f6; -fx-text-fill: white; -fx-border-radius: 3;");
    ...
    private void handleAdd() {
        ...
        departmentComboBox.setPromptText("Choisir un département");
    ...
    private void handleDelete(Professeur professeur) {
        ...
        alert.setContentText("supprimer le professeur ?");
    ...
    private void handleAssign(Professeur professeur) {
        ...
        dialog.showAndWait().ifPresent(departmentId -> {
            ...
            success.setContentText("Le professeur a été assigné avec succès !");
            success.show();
        });
    }
}